...
public class CitaCreatedDomainEvent extends DomainEvent {
    ...
    public CitaCreatedDomainEvent(String aggregateId, String mascotaId, String veterinarioId, Date fecha) {
        super(aggregateId);
    ...
    public CitaCreatedDomainEvent(String aggregateId, String eventId, String occurredOn, String mascotaId, String veterinarioId, Date fecha) {
    ...
    public DomainEvent fromPrimitive(String aggregateId, HashMap<String, Serializable> body, String eventId, String occurredOn) {
        return new CitaCreatedDomainEvent(aggregateId, eventId, occurredOn, (String) body.get("mascotaId"), (String) body.get("veteriarioId"), (Date) body.get("fecha"));
    }
}
